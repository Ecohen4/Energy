...
Already, heating, ventilation and air conditioning (HVAC) account for 35% of total primary energy requirements of the United States (Kwok and Rajkovich 2010). In China, buildings accounted for 24.1% of national energy consumption in 1996, 27.5% by 2001, and are projected to increase to 35% by 2020 (Wan et. al. 2011). Globally, buildings consume an estimated 40% of total primary energy (IEA 2015) or 5348 MTOE in 2012; equivalent in wattage to 50 billion human beings working at peak exertion. At the city-scale, HVAC play an even larger role in driving total final energy consumption and related GHG emissions (compared to national and global averages) due to higher population density, building density, heat-island effect, and tendency towards service-economy. 

The incredible amount of energy consumed in buildings today will only continue to rise as global demand for indoor thermal comfort increases. At the root of the issue is one startling statistic from researchers in China: large commercial buildings with full A/C require 10-20 times more energy per-square foot compared to traditional residential buildings (Wan et. al. 2011, Xu et. al. 2013).
...
In developed cities, building energy use accounts for roughly half of all greenhouse gas emissions attributable to that city (review of eight cities in the U.S. by Hillman and Ramaswami 2009). Specifically, electricity and heating fuel use in buildings generate (on average) as much GHG emissions as all surface trasportation, airline travel, upstream fuel processing, food production, cement manufacturing, potable water/wastewater treatment and long-distance freight, combined (e.g. the flow of essential goods and services into and within cities; Hillman and Ramaswami 2009). Of the roughly 50% of urban GHG emissions attributalbe to building energy use, roughly half of that (depending on climate and prevailing architectural design) comes from electricity, with the other half coming from heating and industiral fuels on a life-cycle basis (review of ten international cities by Kennedy et. al. 2010). 
...
Physical-based models are the gold-standard for simulating energy demand in a specific building or class of buildings. However, our study takes an urban-metabolism approach in which the behavior of the entire city is of interest. Few cities in the world publish full building-stock inventories (including residential, commericial, industrial, government and public buildings such as hospitals, libraries and schools) to reasonably estimate total urban energy demand from the bottom-up. For this reason, we opt for statistical approach (described next) using high-resolution electric utility data. 

### Statistical Models
A thrid class of urban energy demand models are statistical; including regression, pure time-series, and mixed-method econometric models.
...
One notable example in this direction (besides our own attemp) is Wan et. al. (2011). Their study is similar in spirit to ours, but differs in methodology. They estimate baseline and future heating and cooling demand for a generic air-conditioned office building in five Chinese cities representing five distinct climate zones. Their study introduces a clever approach for extracting orthogonal (non-redundant) information from colinear meteorological data (dry bulb temperature, wet bulb temperature and solar radiation) via Principal Component Analysis, and then applies the first principal component in a regression framework to estimate building heating and cooling loads. Results are benchmarked to a physical-based building energy model as proof-of-concept. <more on this.>
